...
var precacheConfig = [
    ["index.html", "89a97f03ad3a1aed0fa30ab627e61e5f"],
    ["static/css/main.2f8bd80c.css", "256599077665bb703ed12314e7adc317"],
    ["static/js/main.56a60264.js", "11875103b91eed0120801830093070d8"]
  ],
  cacheName =
  ...
  self.addEventListener("fetch", function(e) {
    if ("GET" === e.request.method) {
      ...
      !t &&
        ...
        ((n = new URL("/cc-admin/index.html", self.location).toString()),
        (t = urlsToCacheKeys.has(n))),
        t &&
          e.respondWith(
            caches

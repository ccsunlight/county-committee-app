...
const App = () => (
    ...
    >
      ...
      <Resource name="glossary-term" options={{ label: 'Glossary' }}   icon={PersonAddIcon} list={GlossaryTermList} create={GlossaryTermCreate} edit={GlossaryTermEdit} remove={Delete} />
